...
N_KNN = 50  # number of edges from one sampled point
...
def prm_planning(sx, sy, gx, gy, ox, oy, rr, N_SAMPLE, N_KNN, MAX_EDGE_LEN):
    print('number of sample_points', N_SAMPLE)
    print('number of edges from one sampled point', N_KNN)
...
def dijkstra_planning(sx, sy, gx, gy, road_map, sample_x, sample_y):
    ...
    while True:
        ...
        # show graph
        if False: #show_animation and len(closed_set.keys()) % 2 == 0:
